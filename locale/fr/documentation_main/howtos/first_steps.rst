...
1. Visualisez l'analyse d'appel
-------------------------------
...
- Questions/réponses avec des explications sur chaque réponse.
...
Si vous changez une question dans la fiche d'évaluation, et que vous voulez relancer une analyse sur un appel, voici comment le faire :
